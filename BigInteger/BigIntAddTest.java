...
public class BigIntAddTest {
    ...
    public void testAddWithCarry() {
        ...
        assertEquals("9+9 % 10 != 8? (digit 0 of 018)", 8, b18.get(0));
        assertEquals("9+9/10 % 10 != 1? (digit 1 of 018)", 1, b18.get(1));
        assertEquals("9+9/100 % 10 != 0? (digit 2 of 018)", 0, b18.get(2));
    }
