...
public class BigIntBasicsTest {
    ...
    public void BigIntActuallyBig() {
        ...
        BigInt a = new BigInt(s.length());
        assertEquals("ndigits is not right after basic constructor", 39, a.ndigits);
        assertEquals("ndigits is not right after basic constructor", 39, b.ndigits);
    }
}
