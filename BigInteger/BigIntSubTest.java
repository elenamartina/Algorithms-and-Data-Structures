...
public class BigIntSubTest {
    ...
    @Test
    public void testSubWithMultipleBorrow() {
        BigInt b11 = new BigInt(4);
        b11.data[0] = 0;
        b11.data[1] = 0;
        b11.data[2] = 0;
        b11.data[3] = 1;
        ...
        b3.data[0] = 1;
        BigInt b18 = b11.Sub(b3);
        assertEquals("1000-1 % 10 != 9?", 9, b18.get(0));
        assertEquals("1000-1/10 % 10 != 9?", 9, b18.get(1));
        assertEquals("1000-1/100 % 10 != 9?", 9, b18.get(2));
        assertEquals("1000-1/1000 % 10 != 0?", 0, b18.get(3));
    }
    @Test
